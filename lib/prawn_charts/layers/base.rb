module PrawnCharts::Layers
  # PrawnCharts::Layers::Base contains the basic functionality needed by the various types of graphs.  The Base
  ...
  #
  # Assuming the information generated by PrawnCharts::Layers::Base is sufficient, you can create a new graph type
